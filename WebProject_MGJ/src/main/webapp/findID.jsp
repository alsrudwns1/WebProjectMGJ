			...
			<div class="contents login_contents">
				<div class="inner">
					<div class="login_area">
						<h2>ID 찾기</h2>
						<form method="post" action="findID.do" onsubmit="return showError('${error}')">
							<div>
								<label for="email">이메일:</label> <input type="text" id="email"
									name="email" required>
							</div>
							<div>
								<button class="login_btn" type="submit">찾기</button>
							</div>
						</form>
					</div>
					<ul class="link_wrap">
						<li><a href="./findpass.do">비밀번호 찾기</a></li>
						<li><a href="#">아이디 찾기</a></li>
						<li><a href="./create.do">회원가입</a></li>
					</ul>
				</div>
			</div>
		</main>
