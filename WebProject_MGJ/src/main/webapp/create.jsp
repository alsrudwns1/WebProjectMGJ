						...
						<form name="registForm" method="post" action="./create.do"
							...
							<div class="mb-3">
								<label for="exampleInputtext1" class="form-label">아이디</label> <input
									...
									aria-describedby="textHelp" name="id"><br />
							</div>
							<div class="mb-3">
							...
							<div class="mb-4">
								...
								<input type="password" class="form-control"
									id="exampleInputPassword1" name="pass2">
							</div>
							<div class="mb-4">
							...
							<input type="submit" class="login_btn" value="sign up[회원가입 하기]">
						</form>
					</div>
					<ul class="link_wrap">
						<li><a href="login.jsp">로그인 화면으로 돌아가기</a></li>
					</ul>
				</div>
			</div>
		</main>
